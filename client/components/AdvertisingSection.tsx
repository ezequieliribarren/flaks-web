      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-8">
            {platforms.map((platform, index) => (
              ...
              >
                <h4 className="font-bold font-lato text-flaks-dark mb-1">
                  {platform.name}
                </h4>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <div key={index} className="text-center">
                ...
                <p className="text-gray-600 font-lato">{benefit.description}</p>
              </div>
            );
          })}
        </div>
                ...
                <CardContent className="p-8 h-full flex flex-col">
                  ...
                  <div className="text-center">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        (window.location.href = "/pauta-publicitaria")
                      }
                    >
        ...
        <div className="bg-gradient-to-br from-flaks-green to-emerald-400 rounded-3xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-black text-black hover:bg-black hover:text-flaks-green font-lato font-bold px-8 py-4 text-lg rounded-xl transition-all duration-300"
            >
