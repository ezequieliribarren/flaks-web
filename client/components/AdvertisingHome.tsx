  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        aria-hidden
        className="md:hidden pointer-events-none select-none absolute right-0 top-1/2 -translate-y-1/2 h-[70%] opacity-10 object-contain"
      />
            ...
            <ul className="space-y-4">
              {bullets.map((b, i) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-5 h-5 text-flaks-violet-light mt-0.5 flex-shrink-0" />
                    <span>{b.text}</span>
                  </li>
                );
              })}
